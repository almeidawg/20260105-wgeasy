-- ============================================================================
-- SCRIPT: Criar tabela cadastros_pendentes (Sistema de Links de Cadastro)
-- Data: 2026-01-08
...
-- ============================================================================
SELECT 'Tabela criada!' AS resultado
WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'cadastros_pendentes');
