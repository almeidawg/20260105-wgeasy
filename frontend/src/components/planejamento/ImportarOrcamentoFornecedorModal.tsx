      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {(etapa === "revisar" || etapa === "importando") && orcamento && (
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200">
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">{orcamento.fornecedor.nome}</h3>
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              <p className="font-medium text-gray-700 text-sm">Opções de importação:</p>
              <div className="space-y-2">
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="bg-gray-50 px-4 py-3 border-t">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold" style={{ color: WG_ORANGE }}>
        ...
        {etapa === "concluido" && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-900 font-semibold mb-2">Importação concluída!</p>
