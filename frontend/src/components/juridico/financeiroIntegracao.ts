// Função para gerar transações a receber no módulo Financeiro ao criar parcelas de contrato
...
// Para uso: chamar essa função ao criar cada parcela de contrato
