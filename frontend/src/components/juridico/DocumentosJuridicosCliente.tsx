...
export default function DocumentosJuridicosCliente({ clienteId, clienteNome }: DocumentosJuridicosClienteProps) {
  ...
  async function carregarDriveLink() {
    ...
    try {
      ...
      // Se tem drive_link, buscar a pasta juridico
      if (data?.drive_link) {
  ...
  async function buscarPastaJuridico(link: string) {
  ...
  async function carregarArquivosDireto(folderId: string) {
    try {
  ...
  async function carregarArquivos(juridicoFolderId: string) {
    try {
    ...
    return (
      <div className="bg-white rounded-xl border border-dashed border-gray-300 p-6">
        <div className="text-center py-6">
          ...
          <h3 className="text-lg font-semibold text-gray-600">Pasta do Cliente</h3>
    ...
    return (
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">Documentos Jurídicos</h3>
