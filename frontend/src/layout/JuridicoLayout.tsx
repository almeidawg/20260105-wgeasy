/**
 * Layout para Área Jurídica
 * Layout profissional para o departamento jurídico
...
const menuItems = [
  ...
  {
    label: "Modelos",
    href: "/juridico/modelos",
    icon: Briefcase,
  },
  {
    label: "Assistência",
    href: "/juridico/assistencia",
    icon: Scale,
  },
  {
    label: "Financeiro",
    href: "/juridico/financeiro",
    icon: Wallet,
  },
];
...
export default function JuridicoLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AreaHeader
        usuario={{
          nome: usuario?.nome || "Jurídico",
          avatar_url: usuario?.avatar_url,
          data_inicio_wg: usuario?.data_inicio_wg,
          cargo: usuario?.cargo,
          empresa: usuario?.empresa,
        }}
        titulo="Área Jurídica"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center gap-3">
              <Link to="/juridico" className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem asChild>
                    <Link to="/juridico/perfil" className="cursor-pointer">
      ...
      <footer className="border-t border-gray-200 bg-white mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <p className="text-center text-sm text-gray-500">
            Área Jurídica WG &copy; {new Date().getFullYear()} - Grupo WG Almeida
          </p>
        </div>
      </footer>
    </div>
