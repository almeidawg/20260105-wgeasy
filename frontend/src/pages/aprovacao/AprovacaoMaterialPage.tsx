// ============================================================
// PÁGINA PÚBLICA: Aprovação de Pedido de Materiais
...
export default function AprovacaoMaterialPage() {
  ...
  async function carregarPedido() {
    try {
      // Buscar pedido pelo token de aprovação
      ...
      if (pedidoData.status !== "aguardando_aprovacao") {
        setStatus("expirado");
        setErro("Este pedido não está mais disponível para aprovação.");
        return;
      }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-[#F25C26] to-[#e04a1a] rounded-t-2xl p-6 text-white">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-xl font-bold">Pedido de Materiais</h1>
              <p className="text-sm opacity-90">Aguardando sua aprovação</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-b-2xl shadow-xl">
          ...
          <div className="p-6 flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 px-6 py-3 border-2 border-red-500 text-red-600 rounded-xl font-semibold hover:bg-red-50 disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {processando ? (
