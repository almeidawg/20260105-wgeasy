        ...
        <header className="bg-gradient-to-r from-slate-800 via-slate-900 to-slate-800 rounded-2xl p-6 lg:p-8 shadow-lg">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <div className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
                  {usuario?.foto_url ? (
                    ...
                    <span className="text-3xl font-bold text-white">{usuario?.nome?.charAt(0) || 'W'}</span>
                  )}
                </div>
              ...
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">WG Easy · Dashboard Executivo</p>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
              {fraseDoDia && (
                <div className="flex items-start gap-2 max-w-md bg-slate-700/50 rounded-xl p-4 border border-slate-600/50">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">— {fraseDoDia.autor}</p>
                  </div>
                </div>
              )}
              ...
              <div className="bg-slate-700/50 rounded-xl p-4 border border-slate-600/50 min-w-[180px]">
                ...
                <p className="text-xs text-gray-400">Sprint global WG concluída nesta semana.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              {/* Cards de exemplo - serão substituídos por dados reais */}
              <div
                onClick={() => navigate('/contratos')}
                className="flex flex-col items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-xl cursor-pointer transition-colors min-w-[100px]"
              >
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mb-2 overflow-hidden">
                  <Users className="w-6 h-6 text-orange-500" />
                </div>
                <p className="text-xs font-medium text-gray-700 text-center truncate w-full">Cliente 1</p>
                <p className="text-[10px] text-gray-400">#ENG-2025</p>
                <button type="button" className="mt-2 p-1.5 text-gray-400 hover:text-gray-600" title="Ver detalhes">
              ...
              <div
                ...
                className="flex flex-col items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-xl cursor-pointer transition-colors min-w-[100px]"
              >
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-2 overflow-hidden">
                  <Users className="w-6 h-6 text-blue-500" />
                </div>
                <p className="text-xs font-medium text-gray-700 text-center truncate w-full">Cliente 2</p>
                <p className="text-[10px] text-gray-400">#ARQ-2025</p>
                <button type="button" className="mt-2 p-1.5 text-gray-400 hover:text-gray-600" title="Ver detalhes">
                  <ChevronRight className="w-4 h-4" />
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-3 max-h-[280px] overflow-y-auto">
              {eventos.map((evento) => (
                <div key={evento.id} className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  <div className={`w-2 h-2 mt-2 rounded-full ${
                    evento.tipo === 'reuniao' ? 'bg-blue-500' :
                    evento.tipo === 'entrega' ? 'bg-emerald-500' :
                    evento.tipo === 'visita' ? 'bg-violet-500' :
                    'bg-amber-500'
                  }`} />
                  <div className="flex-1 min-w-0">
                    ...
                    {evento.cliente && (
                      <p className="text-xs text-gray-400 mt-0.5">{evento.cliente}</p>
                    )}
                  </div>
                </div>
              ))}
            ...
            <button type="button" onClick={() => navigate('/cronograma')} className="w-full mt-4 py-2.5 text-sm text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-xl transition-colors">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Checklist do Dia</h3>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            ...
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-200 relative overflow-hidden">
              ...
              <p className="text-[10px] text-gray-500 mt-1">Histórico + Sistema</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Curva S (Acumulado)</h3>
                  <p className="text-sm text-gray-500">Receitas vs Despesas - Últimos 6 meses</p>
                </div>
              ...
              <div className="h-[280px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={dadosMensais}>
                    ...
                    />
                    <Area type="monotone" dataKey="receitas" stroke="#10b981" strokeWidth={2} fillOpacity={1} fill="url(#colorReceitasCEO)" name="Receitas" />
                    <Area type="monotone" dataKey="despesas" stroke="#9ca3af" strokeWidth={2} fillOpacity={1} fill="url(#colorDespesasCEO)" name="Despesas" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 h-6 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-orange-300 rounded-full" style={{ width: '45%' }} />
                  </div>
                </div>
                {/* Marcenaria */}
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 h-6 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-orange-200 rounded-full" style={{ width: '30%' }} />
                  </div>
                </div>
              </div>
            </div>
