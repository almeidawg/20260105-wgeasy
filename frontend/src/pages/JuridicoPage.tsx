...
export default function JuridicoPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      setLoading(true);
      // Buscar todos os contratos (sem paginação/filtros para exibir todos)
  ...
  // Função para criar contrato e integrar com financeiro/cronograma
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Jurídico - Contratos</h1>
      ...
      <div className="mb-4 flex flex-wrap gap-2 items-center">
        <label htmlFor="nucleoFiltro" className="text-sm font-medium text-gray-700">
          Filtrar por Núcleo:
        </label>
        <select
          id="nucleoFiltro"
