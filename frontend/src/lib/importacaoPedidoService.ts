// ============================================================
// SERVICE: Importação de Pedidos de Fornecedores
...
/**
 * Regex patterns para extração de dados do PDF
 */
const PATTERNS = {
  ...
  // Linha de item (código, descrição, unidade, quantidade, preço unitário, total)
...
export async function buscarMatchesPricelist(
  ...
  // Buscar todos os itens do pricelist para comparação
...
// ============================================================
// CONVERSÃO PARA ITENS DO PEDIDO
// ============================================================
